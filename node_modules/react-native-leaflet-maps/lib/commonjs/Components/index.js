...
var _html = _interopRequireDefault(require("../assets/html"));
...
const LeafletView = _ref => {
  ...
  const handleMessage = (0, _react.useCallback)(event => {
    ...
    if (message.msg === _types.LeafletWebViewEvents.MAP_READY) {
      sendInitialMessage();
    }
    if (message.event === _types.LeafletWebViewEvents.ON_MOVE_END) {
  ...
  if (webViewRef === null) {
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, null, /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, "ERROR"));
  }
