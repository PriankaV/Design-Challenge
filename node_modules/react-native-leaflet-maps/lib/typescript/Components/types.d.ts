...
export declare enum LeafletWebViewEvents {
...
export interface LeafletWebViewMessagePayload {
    bounds?: LatLngBounds;
    mapCenterPosition: LatLng;
    mapMarkerID?: string;
    touchLatLng?: LatLng;
...
export interface LeafletWebViewMessage {
    event?: any;
    msg?: string;
    error?: string;
    payload?: LeafletWebViewMessagePayload;
}
